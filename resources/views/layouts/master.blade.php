...
<body>
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ URL::to('assets/img/logo-small.jpg') }}" alt="Logo">
                </a>
                                    ...
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image" src="{{ URL::to('assets/img/logo-small.jpg') }}">
                                            </span>
        ...
        @yield('content')
        <footer>
            <p>Copyright ©  <?php echo date('Y'); ?> KeoChendara</p>
        </footer>
